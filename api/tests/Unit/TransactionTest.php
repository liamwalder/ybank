...
class TransactionTest extends TestCase
{
    ...
    public function testTransactionStoringFailsWhenNextInputtingToFieldForUnknownAccount()
    {
        ...
        $response
            ...
            ->assertJsonFragment([
                'to' => [
                    'The account you are trying send to doesn\'t exist.'
                ]
            ]);
    }
    ...
    public function testTransactionStoringFailsWhenNextInputtingToFieldSameAsFromAccount()
    {
        ...
        $response
            ...
            ->assertJsonFragment([
                'to' => [
                    'Sorry. You can not send money to yourself.'
                ]
            ]);
    }
    ...
    public function testTransactionStoringFailsWhenNextInputtingAmountFieldNotFormattedCorrectly()
    {
        ...
        $response
            ...
            ->assertJsonFragment([
                'amount' => [
                    'Please enter a correctly formatted money amount.',
                    'You don\'t have enough balance to send that amount of money.'
                ]
            ]);
    }
